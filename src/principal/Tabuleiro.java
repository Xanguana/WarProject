 ...
 * 
 * Esta classe é uma das classes principais do jogo que leva consigo quase todos os pré-requisitos no qual os métodos
 * definidos aqui é de responsabilidade do tabuleiro executar para iniciar o jogo definindo os terirtorios para cada 
 * jogador e mostrandos os respectivos vizinhos
 */
...
public class Tabuleiro {
	 ...
	 * @param paises
	 * 
	 * Método que define para cada jogador seus territórios sendo 24 o total de territorios no qual por pré-requisito
	 * é feito a divisão de 24 / pelo numero de jogadores. Todo o processo é feito de forma aleatoria então nunca se 
	 * sabe quem vai ficar com tal territorio. Os paises sao controlados por id, entao no if já é definido que um determinado
	 * pais já está ocupado e o total de territorios que o jogador possui, ou seja na medida que ele vai conquistanto 
	 * mais territorios vai sendo verificado
	 */
	 ...
	 * 
	 * Instancia de todos os continentes para construir o tabuleiro, todos já referenciados em um ArrayList. Para cada 
	 * instancia já é definido nas classes quais paises fazem parte de tal continente, pois é fixo, nunca vai mudar
	 */
	 ...
	 * @see Pais()
	 * 
	 * Adicionando os paises no ArrayList e definindo os indices de cada um
	 */
	 ...
	 * @see Objetivos()
	 * 
	 * Instancia de todos os objetivos do jogo sendo adicionados ao arraylist 'obj'
	 */
	...
	public void carregaObjetivos() {
		...
		obj.add(new Objetivos(7, "Destruir o exército preto, se for você o exército preto ou se ele não estiver no jogo, seu objetivo passa a ser conquistar 24 territórios.", false));
		obj.add(new Objetivos(8, "Destruir o exército branco, se for você o exército branco ou se ele não estiver no jogo, seu objetivo passa a ser conquistar 24 territórios.", false));
		obj.add(new Objetivos(9, "Destruir o exército azul, se for você o exército azul ou se ele não estiver no jogo, seu objetivo passa a ser conquistar 24 territórios.", false));
		obj.add(new Objetivos(10,"Destruir o exército amarelo, se for você o exército amarelo ou se ele não estiver no jogo, seu objetivo passa a ser conquistar 24 territórios.", false));	
	}
	
	/**
	 * 
	 * @param nro_jogador - quantidade total de jogadores
	 * 
	 * Neste método é definido ao jogador sua cor e seu objetivo. A partir daí a cor escolhida já não pode mais ser usada.
	 * Os territorios já sao definidos e já define todos os vizinhos e alem disso pode ser definido para cada territorio os 
	 * exeritos de acordo em como o jogador irá organiza-los.
	 */
	 ...
	 * @param jogador
	 * 
	 * Define o objetivo de forma aleatoria para cada jogador de forma que não saia o mesmo objetivo. 
	 */
	...
	/**
	 * @see Cor()
	 * Instância das cores já pré definidas no jogo sendo adicionadas ao ArrayList 'cores'
	 */
	...
	/** 
	 * @param jogador - para definir a cor para um determinado jogador de acordo com sua preferência. 	 * 
	 * É feito a escolha através do nome ignorando o case, se uma cor foi escolhida outro jogador não poderá utiliza-la
	 */
	...
	/**
	 * Metodo usado para chamar todos os outros métodos que só faz o carregamento para funcionamento do jogo e definição 
	 * do tabuleiro além de já definir a quantidade de jogadores para iniciar o jogo.
	 */
	...
	/**
	 * @see Jogador()
	 * Método define a quantidade máxima de jogadores sendo no caso 5. Para cada quantidade de jogador é feito a verificação 
	 * de acordo com os métodos que o tabuleiro executa. Cada Jogador possui um menu individual para determinar suas ações
	 * no jogo. Enquanto os jogadores vão atacando e alcançando os objetivos o jogo é executado até dar o game over.
	 */

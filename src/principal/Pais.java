 ...
 * @see Pais(), Militar(), Jogador()
 * 
 * Classe para definir os países do tabuleiro e os militares que vão estar em cada região
 *
 */
...
public class Pais {
	...
	/**
	 * 
	 * @param nome - para definir o pais que se trata
	 * @param id - para referenciar os países
	 * @see Militar(), Cabo(), Sargento(), Soldado(), Tenente()
	 * 
	 * Este método instância os tipos de Militares e adiciona eles nos países, os tipos de militares são controlados no Array
	 */
	...
	/**
	 * @param paises
	 * @see Angola(), Camaroes(), CostaMarfim(), Egito()
	 * @see Canada(), Dinamarca(), EstadosUnidos(), Mexico()
	 * @see Argentina(), Bolivia(), Brasil(), Venezuela()
	 * @see Afeganistao(), China(), CoreiaSul(), India()
	 * @see Espanha(), Inglaterra(), Italia(), Russia()
	 * @see /australia(), Fiji(), Indoneia(), NovaZelandia()	 * 
	 * 
	 * Todos os países são controlados por um índice que o referência. Este método está definindo para cada
	 * país quais são seus vizinhos, pois o jogador pode atacar somente países vizinhos.
	 */
